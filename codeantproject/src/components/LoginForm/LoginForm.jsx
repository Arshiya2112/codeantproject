    ...
    <div className="main-login">
      <div className="login-form">
        ...
        {activeButton === "SAAS" && (
          <div className="form-options">
            ...
            <button>
              ...
              Sign in with Bitbucket</button>
            <button>
              <img src={devopsimg} alt="" />
              Sign in with Azure Devops</button>
            <button>
        ...
        {activeButton === "Self Hosted" && (
          <div className="form-options">
            <button>
              <img src={gitlabimg} alt="" />Self Hosted GitLab</button>
            <button>
              <img src={ssoimg} alt="" />Sign in with SSO</button>
          </div>
        )}
      </div>
      <p>
